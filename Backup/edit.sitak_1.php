...
<div class="col-md-6">
        <div class="form-group">
          ...
          <input tipe="text" class="form-control input-sm" name="total_ap" id="total_ap" value="<?php echo $row[54] ?>" disabled/>
        </div>
    </div>
    
    <!--<div class="col-md-6">
      <div class="form-group">
        <label class="control-label" for="status_data"><i class="fa fa-map-marker"></i>STATUS DATA</label>
        <select name="status_data" class="form-control input-sm">
            <option value="verify" <?php CekPlan("verify", strtolower($row[33])); ?>>VERIFY</option>
            <option value="unverify" <?php CekPlan("unverify", strtolower($row[33])); ?>>UNVERIFY</option>
            <option value="rejected" <?php CekPlan("rejected", strtolower($row[33])); ?>>REJECTED</option>
        </select>
      </div>
    </div>-->
