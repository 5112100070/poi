...
<div class="col-md-12">
  ...
  <tr>
    ...
    <td align="center">
        <a href="edit.progress.deployment.php?site_id=<?php echo $row[7]; ?>&witel=NULL&jenis=NULL" style="text-decoration:none"><font color="#E12E32"><i class="fa fa-pencil"></i></font></a>
    </td>
    <?php } ?>
