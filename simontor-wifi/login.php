                    ...
                    <div class="row">
                        <div class="col-md-7">
                          <div class="form-group"><br /><br />
                            <p align="center"><img src="img/logopoi1.png" width="300" class="img img-responsive"></p>
                          </div>
                        </div>
                    <div class="col-md-5">
            ...
            <div class="col-lg-8 col-lg-offset-2">  
                <div class="panel panel-danger">
                  <div class="panel-body">
                    <div class="row">
                          <div class="form-group"><br /><br />
                              <p align="center"><img src="img/keterangan.jpg" width="100%" height="100%" class="img img-responsive"></p>
                          </div>
                    </div>
                  </div>
                  </div>
