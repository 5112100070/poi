...
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and (tanggal_kunjungan=to_date('".  date('d-M-y')."')) then 1 else 0 end) as kunjungan_hari_ini,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and (tanggal_kunjungan BETWEEN to_date('1-Jan-15') and to_date('".date('d-M-y')."')) then 1 else 0 end) as kunjungan_hari_sd,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='ok' and (tanggal_kunjungan=to_date('".  date('d-M-y')."')) then 1 else 0 end) as sukses_sitak_hari_ini,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='ok' and (tanggal_kunjungan BETWEEN to_date('1-Jan-15') and to_date('".  date('d-M-y')."')) then 1 else 0 end) as sukses_sitak_sd,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='nok' and (tanggal_kunjungan=to_date('".  date('d-M-y')."')) then 1 else 0 end) as nok_sitak_hari_ini,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='nok' and (tanggal_kunjungan BETWEEN to_date('1-Jan-15') and to_date('".  date('d-M-y')."')) then 1 else 0 end) as nok_sitak_sd,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='pending' and (tanggal_kunjungan=to_date('".  date('d-M-y')."')) then 1 else 0 end) as pending_sitak_hari_ini,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='pending' and (tanggal_kunjungan BETWEEN to_date('1-Jan-15') and to_date('".  date('d-M-y')."')) then 1 else 0 end) as pending_sitak_sd,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='ok' and lower(ket_status_sitac)='valid' and tanggal_kunjungan=to_date('".date('d-M-y')."','DD-MM-YYYY') then 1 else 0 end) as upload_ws_hari_ini,
sum(case when (lower(prioritas)='prio-1' or lower(prioritas)='prio-2' or lower(prioritas)='prio-3') and lower(status_sitac)='ok' and lower(ket_status_sitac)='valid' and (tanggal_kunjungan BETWEEN to_date('1-Jan-15') and to_date('".  date('d-M-y')."')) then 1 else 0 end) as upload_ws_sd
...
<div class="col-md-12">
  ...
  <tr>
    ...
    <td align="center"><a href="detil.sitak.php?jenis=upload_ws_today&witel=<?php echo $row[0]; ?>&tgl=<?php echo date('d-M-y') ?>" style="color: red;text-decoration: none;"><?php echo $row[10]; ?></a></td>
    <td align="center"><a href="detil.sitak.php?jenis=upload_ws_sd&witel=<?php echo $row[0]; ?>&tgl=<?php echo date('d-M-y') ?>" style="color: red;text-decoration: none;"><?php echo $row[11]; ?></a></td>
  ...
  $upload_ws_today=$upload_ws_today+$row[10];
  $upload_ws_sd=$upload_ws_sd+$row[11];
  ...
  <tr>
    ...
    <td align="center"><a href="detil.sitak.php?jenis=upload_ws_sd&witel=all&tgl=<?php echo date('d-M-y') ?>" style="color: red;text-decoration: none;"><strong><?php echo $upload_ws_sd ?></strong></a></td>
