        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a href="index_map.php">HOME</a></li>
            ...
            <li class="dropdown" style="display: <?php 
                if($_SESSION['privilege']!=8) 
                    ...
                    ?>">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="fa fa-instagram"></i>INPUT DATA<span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a href="input.potensi.php">INPUT SITAC BARU</a></li>
              </ul>
            </li>
            <li class="dropdown">
