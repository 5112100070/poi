<?php
        ...
        //End Update data REPORT_DATA_DEMAND proses
            if($_GET['witel']=="NULL" && $_GET['jenis']=="NULL")header("Location: edit.sitak.php?site_id=".$_GET['site_id']."&witel=NULL&jenis=NULL&status_update=".$status_input."&tgl=".date("d-m-y"));
            else header("Location: detil.sitak.php?witel=".$_GET['witel']."&jenis=".$_GET['jenis']."&status_update=".$status_input."&tgl=".date("d-m-y"));     
?>