<?php
        ...
        $sql = "INSERT INTO REPORT_DATA_DEMAND(ID,ID_WS,ID_SITE,NAMA_SITE,LONGITUDE,LATITUDE,ALAMAT,WITEL,MITRA_AP,PRIORITAS,STATUS_INDIHOME,NO_INDIHOME,STATUS_DATA)"
                ...
                . "'".strtoupper($_POST['status_indihome'])."',"
                . "'".strtoupper($_POST['no_indihome'])."',"
